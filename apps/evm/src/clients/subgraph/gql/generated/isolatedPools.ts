...
export enum AccountVTokenBadDebt_OrderBy {
  ...
  AccountBorrowIndex = 'account__borrowIndex',
  AccountEnteredMarket = 'account__enteredMarket',
  AccountId = 'account__id',
  AccountStoredBorrowBalanceMantissa = 'account__storedBorrowBalanceMantissa',
  ...
  AccountVTokenBalanceMantissa = 'account__vTokenBalanceMantissa',
