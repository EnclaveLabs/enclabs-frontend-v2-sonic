...
export const PALETTE = {
  mode: 'dark',
  background: {
    default: theme.extend.colors.background,
    paper: theme.extend.colors.lightCards,
    black: '#1F2028',
    lightGrey: theme.extend.colors.lightGrey,
  },
  secondary: {
    light: theme.extend.colors.lightBlack,
    main: theme.extend.colors.background,
    dark: 'rgba(18, 22, 32, 1)',
  },
  text: {
    primary: theme.extend.colors.lightBlack,
