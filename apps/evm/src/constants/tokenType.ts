...
export const tokenType = {
  ...
  Stable: [
    ...
    "0xd02962DC00A058a00Fc07A8AA9F760ab6D9Bd163", // Enclabs veUSD
  ],
...
export const tokenTypeInfo: {
  ...
  LST: {
    ...
    buttonClassName:
      "bg-tagTextOrange bg-tagTextOrange border-tagTextOrange hover:border-tagTextOrange hover:bg-hoverOrange text-lightBlack",
    shadowClassName: "shadow-md shadow-hoverOrange",
    getUrl: (tokenAddress: string, chain: string) => `swap`,
  },
  PT: {
    ...
    buttonClassName:
      "bg-tagTextGreen bg-tagTextGreen border-tagTextGreen hover:border-tagTextGreen hover:bg-hoverGreen text-lightBlack",
  ...
  Wrapped: {
    ...
    buttonClassName:
      "bg-tagTextYellow bg-tagTextYellow border-tagTextYellow hover:border-tagTextYellow hover:bg-hoverYellow text-lightBlack",
  ...
  aToken: {
    ...
    buttonClassName:
      "bg-tagTextRed bg-tagTextRed border-tagTextRed hover:border-tagTextRed hover:bg-hoverRed text-lightBlack",
  ...
  "Yield bearing Stable": {
    ...
    buttonClassName:
      "bg-tagTextBlue bg-tagTextBlue border-tagTextBlue hover:border-tagTextBlue hover:bg-hoverBlue text-lightBlack",
  ...
  Unknown: {
    ...
    buttonClassName:
      "bg-tagTextGrey bg-tagTextGrey border-tagTextGrey hover:border-tagTextGrey hover:bg-hoverGrey text-lightBlack",
