...
export const pointTypeInfo: {
  ...
  enclabsPointsX1: {
    ...
    tooltipLink:
      "https://enclabs.gitbook.io/enclabs-documentation/enclabs-on-sonic/enclabs-points",
  },
  enclabsPointsX2: {
    logo: enclabsPointsLogo,
    multiplier: "x2",
  ...
  SonicPointsX2: {
    ...
    tooltipLink:
      "https://enclabs.gitbook.io/enclabs-documentation/enclabs-on-sonic/sonic-points",
  },
  SonicPointsX4: {
    logo: sonicLogo,
    multiplier: "x8",
