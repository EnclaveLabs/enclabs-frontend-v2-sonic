...
export const contracts: ContractConfig[] = [
  // Unique contracts
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.VenusLens,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.VenusLens,
    },
  },
  {
    name: "PoolLens",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        isolatedPoolsBscTestnetDeployments.addresses.PoolLens,
      [ChainId.BSC_MAINNET]:
        isolatedPoolsBscMainnetDeployments.addresses.PoolLens,
      [ChainId.ETHEREUM]: isolatedPoolsEthereumDeployments.addresses.PoolLens,
      [ChainId.OPBNB_MAINNET]:
        isolatedPoolsOpBnbMainnetDeployments.addresses.PoolLens,
      [ChainId.OPBNB_TESTNET]:
        isolatedPoolsOpBnbTestnetDeployments.addresses.PoolLens,
      [ChainId.SEPOLIA]: isolatedPoolsSepoliaDeployments.addresses.PoolLens,
      [ChainId.ARBITRUM_SEPOLIA]:
        isolatedPoolsArbitrumSepoliaDeployments.addresses.PoolLens,
      [ChainId.ARBITRUM_ONE]:
        isolatedPoolsArbitrumOneDeployments.addresses.PoolLens,
      [ChainId.ZKSYNC_SEPOLIA]:
        isolatedPoolsZkSyncSepoliaDeployments.addresses.PoolLens,
      [ChainId.ZKSYNC_MAINNET]:
        isolatedPoolsZkSyncMainnetDeployments.addresses.PoolLens,
      [ChainId.OPTIMISM_SEPOLIA]:
        isolatedPoolsOptimismSepoliaDeployments.addresses.PoolLens,
  ...
  },
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        isolatedPoolsBscTestnetDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.BSC_MAINNET]:
        isolatedPoolsBscMainnetDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.ETHEREUM]:
        isolatedPoolsEthereumDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.OPBNB_MAINNET]:
        isolatedPoolsOpBnbMainnetDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.OPBNB_TESTNET]:
        isolatedPoolsOpBnbTestnetDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.SEPOLIA]:
        isolatedPoolsSepoliaDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.ARBITRUM_SEPOLIA]:
        isolatedPoolsArbitrumSepoliaDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.ARBITRUM_ONE]:
        isolatedPoolsArbitrumOneDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.ZKSYNC_SEPOLIA]:
        isolatedPoolsZkSyncSepoliaDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.ZKSYNC_MAINNET]:
        isolatedPoolsZkSyncMainnetDeployments.addresses.PoolRegistry_Proxy,
      [ChainId.OPTIMISM_SEPOLIA]:
  ...
  },
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.Unitroller,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.Unitroller,
    },
  },
  {
    name: "VaiController",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.VaiUnitroller,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.VaiUnitroller,
    },
  },
  {
    name: "VaiVault",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.VAIVaultProxy,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.VAIVaultProxy,
    },
  },
  {
    ...
    address: {
      ...
      [ChainId.ARBITRUM_SEPOLIA]:
        tokenBridgeArbitrumSepoliaDeployments.addresses.XVS,
      [ChainId.ARBITRUM_ONE]: tokenBridgeArbitrumOneDeployments.addresses.XVS,
      [ChainId.ZKSYNC_SEPOLIA]:
        tokenBridgeZkSyncSepoliaDeployments.addresses.XVS,
      [ChainId.ZKSYNC_MAINNET]:
        tokenBridgeZkSyncMainnetDeployments.addresses.XVS,
      [ChainId.OPTIMISM_SEPOLIA]:
        tokenBridgeOptimismSepoliaDeployments.addresses.XVS,
      [ChainId.OPTIMISM_MAINNET]:
        tokenBridgeOptimismMainnetDeployments.addresses.XVS,
    },
  },
  {
    name: "XvsVault",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.XVSVaultProxy,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.XVSVaultProxy,
      [ChainId.ETHEREUM]:
        venusProtocolEthereumDeployments.addresses.XVSVaultProxy,
      [ChainId.SEPOLIA]:
        venusProtocolSepoliaDeployments.addresses.XVSVaultProxy,
      [ChainId.OPBNB_MAINNET]:
        venusProtocolOpBnbMainnetDeployments.addresses.XVSVaultProxy,
      [ChainId.OPBNB_TESTNET]:
        venusProtocolOpBnbTestnetDeployments.addresses.XVSVaultProxy,
      [ChainId.ARBITRUM_SEPOLIA]:
        venusProtocolArbitrumSepoliaDeployments.addresses.XVSVaultProxy,
      [ChainId.ARBITRUM_ONE]:
        venusProtocolArbitrumOneDeployments.addresses.XVSVaultProxy,
      [ChainId.ZKSYNC_SEPOLIA]:
        venusProtocolZkSyncSepoliaDeployments.addresses.XVSVaultProxy,
      [ChainId.ZKSYNC_MAINNET]:
        venusProtocolZkSyncMainnetDeployments.addresses.XVSVaultProxy,
      [ChainId.OPTIMISM_SEPOLIA]:
        venusProtocolOptimismSepoliaDeployments.addresses.XVSVaultProxy,
      [ChainId.OPTIMISM_MAINNET]:
        venusProtocolOptimismMainnetDeployments.addresses.XVSVaultProxy,
    },
  },
  {
    name: "XvsStore",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.XVSStore,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.XVSStore,
      ...
      [ChainId.OPBNB_MAINNET]:
        venusProtocolOpBnbMainnetDeployments.addresses.XVSStore,
      [ChainId.OPBNB_TESTNET]:
        venusProtocolOpBnbTestnetDeployments.addresses.XVSStore,
      [ChainId.ARBITRUM_SEPOLIA]:
        venusProtocolArbitrumSepoliaDeployments.addresses.XVSStore,
      [ChainId.ARBITRUM_ONE]:
        venusProtocolArbitrumOneDeployments.addresses.XVSStore,
      [ChainId.ZKSYNC_SEPOLIA]:
        venusProtocolZkSyncSepoliaDeployments.addresses.XVSStore,
      [ChainId.ZKSYNC_MAINNET]:
        venusProtocolZkSyncMainnetDeployments.addresses.XVSStore,
      [ChainId.OPTIMISM_SEPOLIA]:
        venusProtocolOptimismSepoliaDeployments.addresses.XVSStore,
      [ChainId.OPTIMISM_MAINNET]:
        venusProtocolOptimismMainnetDeployments.addresses.XVSStore,
    },
  },
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusGovernanceBscTestnetDeployments.addresses
          .GovernorBravoDelegator_Proxy,
      [ChainId.BSC_MAINNET]:
        venusGovernanceBscMainnetDeployments.addresses
          .GovernorBravoDelegator_Proxy,
    },
  },
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.XVSVestingProxy,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.XVSVestingProxy,
    },
  },
  {
    name: "VrtConverter",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.VRTConverterProxy,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.VRTConverterProxy,
    },
  },
  {
    name: "Maximillion",
  ...
  },
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusOracleBscTestnetDeployments.addresses.ResilientOracle,
      [ChainId.BSC_MAINNET]:
        venusOracleBscMainnetDeployments.addresses.ResilientOracle,
      [ChainId.ETHEREUM]:
        venusOracleEthereumDeployments.addresses.ResilientOracle,
      [ChainId.OPBNB_MAINNET]:
        venusOracleOpBnbMainnetDeployments.addresses.ResilientOracle,
      [ChainId.OPBNB_TESTNET]:
        venusOracleOpBnbTestnetDeployments.addresses.ResilientOracle,
      [ChainId.SEPOLIA]:
        venusOracleSepoliaDeployments.addresses.ResilientOracle,
      [ChainId.ARBITRUM_SEPOLIA]:
        venusOracleArbitrumSepoliaDeployments.addresses.ResilientOracle,
      [ChainId.ARBITRUM_ONE]:
        venusOracleArbitrumOneDeployments.addresses.ResilientOracle,
      [ChainId.ZKSYNC_SEPOLIA]:
        venusOracleZkSyncSepoliaDeployments.addresses.ResilientOracle,
      [ChainId.ZKSYNC_MAINNET]:
        venusOracleZkSyncMainnetDeployments.addresses.ResilientOracle,
      [ChainId.OPTIMISM_SEPOLIA]:
        venusOracleOptimismSepoliaDeployments.addresses.ResilientOracle,
      [ChainId.OPTIMISM_MAINNET]:
  ...
  },
  {
    ...
    address: {
      ...
      [ChainId.ARBITRUM_SEPOLIA]:
        venusProtocolArbitrumSepoliaDeployments.addresses.Prime,
      [ChainId.ARBITRUM_ONE]:
        venusProtocolArbitrumOneDeployments.addresses.Prime,
      [ChainId.ZKSYNC_SEPOLIA]:
        venusProtocolZkSyncSepoliaDeployments.addresses.Prime,
      [ChainId.ZKSYNC_MAINNET]:
        venusProtocolZkSyncMainnetDeployments.addresses.Prime,
      [ChainId.OPTIMISM_SEPOLIA]:
        venusProtocolOptimismSepoliaDeployments.addresses.Prime,
      [ChainId.OPTIMISM_MAINNET]:
        venusProtocolOptimismMainnetDeployments.addresses.Prime,
    },
  },
  {
    name: "VTreasury",
    ...
    address: {
      [ChainId.BSC_TESTNET]:
        venusProtocolBscTestnetDeployments.addresses.VTreasury,
      [ChainId.BSC_MAINNET]:
        venusProtocolBscMainnetDeployments.addresses.VTreasury,
    },
  },
  {
    name: "VTreasuryV8",
    ...
    address: {
      [ChainId.ETHEREUM]:
        venusProtocolEthereumDeployments.addresses.VTreasuryV8,
      [ChainId.SEPOLIA]: venusProtocolSepoliaDeployments.addresses.VTreasuryV8,
      [ChainId.OPBNB_MAINNET]:
        venusProtocolOpBnbMainnetDeployments.addresses.VTreasuryV8,
      [ChainId.OPBNB_TESTNET]:
      ...
      [ChainId.OPTIMISM_SEPOLIA]:
        venusProtocolOptimismSepoliaDeployments.addresses.VTreasuryV8,
      [ChainId.OPTIMISM_MAINNET]:
        venusProtocolOptimismMainnetDeployments.addresses.VTreasuryV8,
    },
  },
  {
    ...
    address: {
      [ChainId.ETHEREUM]:
        tokenBridgeEthereumDeployments.addresses.XVSProxyOFTDest,
      [ChainId.SEPOLIA]:
        tokenBridgeSepoliaDeployments.addresses.XVSProxyOFTDest,
      [ChainId.OPBNB_MAINNET]:
        tokenBridgeOpBnbMainnetDeployments.addresses.XVSProxyOFTDest,
      [ChainId.OPBNB_TESTNET]:
        tokenBridgeOpBnbTestnetDeployments.addresses.XVSProxyOFTDest,
      [ChainId.ARBITRUM_SEPOLIA]:
        tokenBridgeArbitrumSepoliaDeployments.addresses.XVSProxyOFTDest,
      [ChainId.ARBITRUM_ONE]:
        tokenBridgeArbitrumOneDeployments.addresses.XVSProxyOFTDest,
      [ChainId.ZKSYNC_SEPOLIA]:
        tokenBridgeZkSyncSepoliaDeployments.addresses.XVSProxyOFTDest,
      [ChainId.ZKSYNC_MAINNET]:
        tokenBridgeZkSyncMainnetDeployments.addresses.XVSProxyOFTDest,
      [ChainId.OPTIMISM_SEPOLIA]:
        tokenBridgeOptimismSepoliaDeployments.addresses.XVSProxyOFTDest,
      [ChainId.OPTIMISM_MAINNET]:
        tokenBridgeOptimismMainnetDeployments.addresses.XVSProxyOFTDest,
    },
  },
  {
    name: "XVSProxyOFTSrc",
    ...
    address: {
      [ChainId.BSC_MAINNET]:
        tokenBridgeBscMainnetDeployments.addresses.XVSProxyOFTSrc,
      [ChainId.BSC_TESTNET]:
        tokenBridgeBscTestnetDeployments.addresses.XVSProxyOFTSrc,
    },
  },
  {
    name: "ZyFiVault",
  ...
  {
    name: "VTokenVenclabsVeUSDCore",
    abi: VTokenVenclabsVeUSDCoreAbi,
    address: {
      [ChainId.SONIC_MAINNET]: "0x1053fc8c4eaead1edd5276a58e9bddf1001ba143",
    },
  },
  // Generic Contracts
  {
  ...
  // NativeTokenGateway contract addresses for each supported pool
  {
    ...
    address: {
      [ChainId.BSC_TESTNET]: {
        [isolatedPoolsBscTestnetDeployments.addresses.Comptroller_LiquidStakedBNB.toLowerCase()]:
          isolatedPoolsBscTestnetDeployments.addresses
            .NativeTokenGateway_vWBNB_LiquidStakedBNB,
      },
      [ChainId.BSC_MAINNET]: {
        [isolatedPoolsBscMainnetDeployments.addresses.Comptroller_LiquidStakedBNB.toLowerCase()]:
          isolatedPoolsBscMainnetDeployments.addresses
      ...
      [ChainId.OPBNB_MAINNET]: {
        [isolatedPoolsOpBnbMainnetDeployments.addresses.Comptroller_Core.toLowerCase()]:
          isolatedPoolsOpBnbMainnetDeployments.addresses
            .NativeTokenGateway_vWBNB_Core,
      },
      [ChainId.OPBNB_TESTNET]: {
        [isolatedPoolsOpBnbTestnetDeployments.addresses.Comptroller_Core.toLowerCase()]:
          isolatedPoolsOpBnbTestnetDeployments.addresses
            .NativeTokenGateway_vWBNB_Core,
      },
      [ChainId.ETHEREUM]: {
      ...
      [ChainId.ZKSYNC_SEPOLIA]: {
        [isolatedPoolsZkSyncSepoliaDeployments.addresses.Comptroller_Core.toLowerCase()]:
          isolatedPoolsZkSyncSepoliaDeployments.addresses
            .NativeTokenGateway_vWETH_Core,
      },
      [ChainId.ZKSYNC_MAINNET]: {
        [isolatedPoolsZkSyncMainnetDeployments.addresses.Comptroller_Core.toLowerCase()]:
          isolatedPoolsZkSyncMainnetDeployments.addresses
            .NativeTokenGateway_vWETH_Core,
      },
      [ChainId.OPTIMISM_MAINNET]: {
